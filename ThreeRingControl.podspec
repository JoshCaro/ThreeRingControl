...
Pod::Spec.new do |s|
  ...
  s.author             = { "Joshua Caro" => "jcaro@walook.com.mx" }
  # Or just: s.author    = "Joshua Caro"
  # s.authors            = { "Joshua Caro" => "jcaro@walook.com.mx" }
  # s.social_media_url   = "http://twitter.com/Joshua Caro"
